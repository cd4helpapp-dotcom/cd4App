...
type HomeConcern = { id: string; label: string };
        ...
        <>
            ...
            <View style={styles.section}>
                <View style={styles.sectionHeader}>
                    ...
                    <TouchableOpacity onPress={onViewAllDepartments} activeOpacity={0.8} accessibilityLabel="View all concerns" style={styles.viewAllIconButton}><ChevronRight size={20} color={theme.tint} strokeWidth={2.5} /></TouchableOpacity>
                </View>
